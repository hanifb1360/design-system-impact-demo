# Enterprise design-system dogfood

This standalone repository models an enterprise React design system evolving from `@acme/ui` 1.4 to 2.0, a legacy checkout consumer, and its migrated result.
